                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php 
                                ...
                                $petugas = mysqli_query($koneksi,"SELECT * from tb_petugas where level='petugas'");
                                echo mysqli_num_rows($petugas);
							?>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php 
                                include "../config/koneksi.php";
                                $tanggapan = mysqli_query($koneksi,"SELECT * from tb_pengaduan");
